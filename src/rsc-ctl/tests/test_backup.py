"""Tests for ``rsc_ctl.backup.create_backup``.

We replace :class:`rsc_ctl.ssh.SshSession` with an in-memory fake
...
from rsc_ctl import backup as backup_mod  # noqa: E402
from rsc_ctl.backup import BackupError, create_backup  # noqa: E402
...
def test_dry_run_skips_session_but_returns_folder(
    ...
    caplog.set_level(logging.INFO, logger="rsc_ctl")
