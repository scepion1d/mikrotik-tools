...
classification lives in :mod:`rsc.parser.menus`; synthetic-id derivation
for built-in / id-less items lives in :mod:`rsc.parser.identity`.
...
use :func:`rsc.parser.identity.entity_id`.
"""
...
class Item:
    ...
    def identity_key(self, position: int) -> str:
        ...
        need one should use :func:`rsc.parser.identity.entity_id` instead.
        """
